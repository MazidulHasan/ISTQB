...
Each studied syllabus section gets its own folder here, named after its chapter number (e.g. `1.1/`, `2.3/`), created automatically the first time you run `/study {chapter}`.
